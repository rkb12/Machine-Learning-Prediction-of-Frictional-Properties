...
features = pd.read_csv('./../data/ml_data_adh.csv')
...
X_train1, X_test1, y_train, y_test = train_test_split(X,Y,test_size=0.1,random_state=1700)
...
model = GradientBoostingRegressor(random_state=3, n_estimators=500, learning_rate=0.009529999999999816, max_depth=6, min_samples_split= 3, max_features=12)
