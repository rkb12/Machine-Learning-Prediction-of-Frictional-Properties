...
features = pd.read_csv('../data/ml_data_cor.csv')
...
X_train1, X_test1, y_train, y_test = train_test_split(X,Y,test_size=0.1,random_state=101528)
...
model = GradientBoostingRegressor(random_state=214403, learning_rate=0.012799999999999683, n_estimators = 500, max_depth=5, max_features=12)
